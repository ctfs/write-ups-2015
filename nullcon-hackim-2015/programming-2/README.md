...
>
>|t> * |s0> = (1/sqrt(2)) (a|0âŸ©*(|00âŸ©+|11âŸ©)+b|1âŸ©*(|00âŸ©+|11âŸ©))
>= (1/sqrt(2)) (a|000âŸ©+a|011âŸ©+b|100âŸ©+b|111âŸ©)
>
...
>(H * I * I)(Cnot * I)(|tâŸ©*|s0âŸ©)
>
>The result of this will be entangled 3 qubit state.
>
>*Step 2:*
>
>Alice measures the first two qubits and obtains one of the four standard basis states |00âŸ©, |01âŸ©, |10âŸ©, and |11âŸ© with some probability. Depending on the result of her measurement, the quantum state of Bobâ€™s qubit will be projected to certain ensemble of 1-qubit states. Alice sends the result of her measurement as two classical bits 00 or 01 or 10 or 11 to Bob.
>
>*Step 3*
>
>When Bob receives the two classical bits from Alice, he knows how the state of his half of the entangled pair compares to the original state of Aliceâ€™s qubit. Bob can reconstruct the original state of Aliceâ€™s qubit, |tâŸ©, by applying the appropriate decoding transformation (unitary operators) to his qubit, originally part of the entangled pair.
>
